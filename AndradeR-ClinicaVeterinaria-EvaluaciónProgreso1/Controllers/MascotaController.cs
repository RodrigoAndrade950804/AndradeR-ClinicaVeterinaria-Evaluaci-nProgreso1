...
namespace AndradeR_ClinicaVeterinaria_EvaluaciónProgreso1.Controllers
{
    public class MascotaController : Controller
    {
        ...
        public MascotaController(AndradeR_SQL context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MascotaId,Nombre,Especie,Edad,Peso,DueñoId")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MascotaId,Nombre,Especie,Edad,Peso,DueñoId")] Mascota mascota)
        {
